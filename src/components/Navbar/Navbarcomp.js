...
const Navbarcomp = () => {
  ...
  return (
    <div style={{width:'100%'}} >
        <Navbar fixed="top"  className='test' collapseOnSelect expand="lg" bg="success" variant="dark">
  <Container>
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    ...
    <Nav>
      ...
      <Nav style={{color:'white', marginRight:'1vw'}}>CONTACT US</Nav>
      </Link>
      <Link to='/forums' style={{textDecoration:'none'}}>
      <Nav style={{color:'white'}}>FORUMS</Nav>
      </Link>
    </Nav>
  </Navbar.Collapse>
  </Container>
